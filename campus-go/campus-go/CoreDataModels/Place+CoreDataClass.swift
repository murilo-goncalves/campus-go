...
public class Place: NSManagedObject, Decodable {
    ...
    enum CodingKeys: CodingKey {
        case latitude, longitude, placeID, name, nImages, relatedAchievements, prevState
    }
    ...
    required convenience public init(from decoder: Decoder) throws {
        ...
        self.prevState = try container.decode(Int64.self, forKey: .prevState)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(prevState, forKey: .prevState)
